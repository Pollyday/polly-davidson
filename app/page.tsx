    ...
    <div className="min-h-screen bg-[#b5d1cc] text-[#414141] selection:bg-[#ff616b]/25 selection:text-[#253122]">
      ...
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-[#253122] bg-[#fbf6f3]/92 backdrop-blur">
        <div className="mx-auto flex min-h-16 max-w-6xl items-center justify-between gap-4 px-5 py-3 sm:px-6">
          <Link
            href="/"
            className="font-serif text-[var(--type-lede)] font-semibold uppercase leading-none tracking-[-0.04em] text-[#ff616b] transition-colors hover:text-[#253122]"
          >
            Polly Davidson
          </Link>
          <div className="flex flex-wrap justify-end gap-x-4 gap-y-2 text-[var(--type-caption)] font-bold uppercase tracking-[0.2em] text-[#253122] sm:gap-x-8">
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-5 pt-24 pb-16 sm:px-6 lg:pt-28">
        <section className="overflow-hidden border border-[#253122] bg-[#ffb852]">
          <div className="grid border-b border-[#253122] bg-[linear-gradient(rgba(233,235,116,0.58)_1px,transparent_1px),linear-gradient(90deg,rgba(233,235,116,0.58)_1px,transparent_1px)] bg-[size:2.35rem_2.35rem] px-5 py-12 sm:px-8 md:px-12 md:py-20">
            <p className="mb-8 text-[var(--type-caption)] font-bold uppercase tracking-[0.22em] text-[#1b3644]">
              Brand strategist / marketing leader / GitHub
            </p>
            <h1 className="max-w-5xl font-serif text-[var(--type-display)] font-light uppercase leading-[0.82] tracking-[-0.055em] text-[#1b3644] [font-stretch:condensed]">
              I make complicated things interesting.
              <span className="mt-5 block font-sans text-[0.618em] font-semibold leading-[0.9] tracking-[0.04em] text-[#ff616b] md:mt-8">
                Hi, I&apos;m Polly.
              </span>
            </h1>
          </div>
          ...
          <div className="bg-[#fbf6f3] p-5 md:p-8">
            <p className="max-w-2xl text-[var(--type-lede)] leading-relaxed text-[#414141]">
        ...
        >
          <div className="border-b border-[#253122] bg-[linear-gradient(rgba(233,235,116,0.58)_1px,transparent_1px),linear-gradient(90deg,rgba(233,235,116,0.58)_1px,transparent_1px)] bg-[#ffb852] bg-[size:2.35rem_2.35rem] p-5 md:col-span-4 md:border-r md:border-b-0 md:p-8">
            <p className="mb-5 text-[var(--type-caption)] font-bold uppercase tracking-[0.22em] text-[#253122]">
              About me
            </p>
          ...
          <div className="md:col-span-8">
            <div className="border-b border-[#253122] p-5 md:p-8">
              <h2 className="mb-5 font-sans text-[var(--type-heading-md)] font-semibold uppercase leading-none tracking-[0.04em] text-[#ff616b]">
                Strategy, but make it interesting
              </h2>
              <p className="max-w-3xl text-[var(--type-body)] leading-relaxed text-[#414141]">
                I make complicated things easier to understand, harder to ignore and occasionally
                more fun.
              </p>
              <p className="mt-5 max-w-3xl text-[var(--type-body)] leading-relaxed text-[#414141]">
        ...
        <section id="contact" className="py-16 md:py-20">
          <div className="grid overflow-hidden border border-[#253122] bg-[#1b3644] md:grid-cols-[1fr_auto]">
            <div className="p-6 md:p-10">
              <p className="mb-5 text-[var(--type-caption)] font-bold uppercase tracking-[0.22em] text-[#96bfe6]">
                Contact
              </p>
              <h2 className="max-w-3xl font-sans text-[var(--type-heading-md)] font-semibold uppercase leading-none tracking-[0.04em] text-[#bfabcc]">
                Want this brain on your brand?
              </h2>
              <p className="mt-6 max-w-2xl text-[var(--type-body)] leading-relaxed text-[#bfabcc]/80">
      ...
      <footer className="relative z-10 border-t border-[#253122] bg-[#fbf6f3] px-5 py-6 text-center text-[var(--type-caption)] font-bold uppercase tracking-[0.18em] text-[#414141]">
        <p>
          Made by{" "}
          <a
...
function SectionHeader({
  ...
  return (
    <div className="mb-8 grid gap-4 border border-[#253122] bg-[#1b3644] p-5 md:grid-cols-[auto_1fr] md:items-end md:p-8">
      <div>
        <p className="mb-3 text-[var(--type-caption)] font-bold uppercase tracking-[0.22em] text-[#96bfe6]">
          {eyebrow}
        </p>
        <h2 className="font-sans text-[var(--type-heading-md)] font-semibold uppercase leading-none tracking-[0.04em] text-[#bfabcc]">
          {title}
        </h2>
      </div>
      {description ? (
        <p className="max-w-lg text-[var(--type-body)] leading-relaxed text-[#bfabcc]/80 md:justify-self-end md:text-right">
          {description}
        </p>
      ) : null}
    </div>
...
function ProjectCard({
  ...
  return (
    ...
    >
      {eyebrow ? (
        <p className="mb-4 text-[var(--type-caption)] font-bold uppercase tracking-[0.2em] text-[#ff616b]">
          {eyebrow}
        </p>
      ) : null}
      <div className="mb-8 flex items-start justify-between gap-6">
        <h3
          className={`font-sans font-semibold uppercase leading-none tracking-[0.04em] text-[#253122] transition-colors group-hover:text-[#ff616b] ${
            featured ? "text-[var(--type-heading-lg)]" : "text-[var(--type-heading-md)]"
          }`}
        >
          {title}
        </h3>
      ...
      <p className={`${featured ? "max-w-3xl" : "max-w-xl"} text-[var(--type-body)] leading-relaxed text-[#414141]`}>
        {description}
      </p>
      {result ? (
        <p className="mt-5 max-w-2xl border border-[#253122] bg-[#ffb852] px-4 py-3 text-[var(--type-body)] font-bold uppercase leading-relaxed tracking-[0.08em] text-[#253122]">
          {result}
        </p>
      ) : null}
      <div className="mt-6 flex flex-wrap gap-2">
        {tags.map((tag) => (
          <span
            key={tag}
            className="border border-[#253122] bg-[#ffa6d9] px-2.5 py-1 text-[var(--type-caption)] font-bold uppercase tracking-[0.1em] text-[#253122]"
          >
            {tag}
          </span>
        ))}
...
function InfoList({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="border-b border-[#253122] p-5 last:border-b-0 md:border-r md:border-b-0 md:p-8 even:md:border-r-0">
      <h3 className="mb-5 text-[var(--type-caption)] font-bold uppercase tracking-[0.22em] text-[#ff616b]">
        {title}
      </h3>
      <ul className="space-y-3 text-[var(--type-body)] leading-relaxed text-[#414141]">
        {items.map((item) => (
...
function SocialLink({ href, label }: { href: string; label: string }) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-between border-b border-[#253122] px-6 py-4 text-[var(--type-caption)] font-bold uppercase tracking-[0.18em] text-[#253122] transition-colors last:border-b-0 hover:bg-[#96bfe6] hover:text-[#1b3644]"
    >
      {label}
