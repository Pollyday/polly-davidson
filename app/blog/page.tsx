      ...
      <main className="mx-auto max-w-6xl px-5 pt-24 pb-16 sm:px-6 lg:pt-28">
        <section className="overflow-hidden border border-[#253122] bg-[#fbf6f3]">
          <div className="border-b border-[#253122] bg-[#1b3644] p-6 md:p-10">
            ...
            <h1 className="max-w-4xl font-sans text-[var(--type-heading-lg)] font-semibold uppercase leading-none tracking-[0.04em] text-[#bfabcc]">
          ...
          <div className="grid md:grid-cols-2">
            {posts.map((post) => (
              ...
              >
                ...
                <h2 className="font-sans text-[var(--type-heading-md)] font-semibold uppercase leading-none tracking-[0.04em] text-[#253122]">
                  {post.title}
                </h2>
                <p className="mt-6 max-w-xl text-[var(--type-body)] leading-relaxed text-[#414141]">
                  {post.description}
                </p>
              </article>
            ))}
